...
const TOOLS = [
  {
    to: '/fees',
    Icon: ScaleIcon,
    title: 'محاسبه هزینه سند',
    text: 'برآورد تخمینی حق‌التحریر، حق‌الثبت و مالیات بر اساس تعرفه مصوب.',
  },
  {
    to: '/checklist',
    Icon: CheckBadgeIcon,
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-10 max-w-2xl mx-auto">
            ...
            <p className="text-slate-500 leading-relaxed">
              مدارک لازم، مراحل انجام، هزینه تخمینی و سوالات متداول هر خدمت را جداگانه
              بخوانید.
            </p>
          </div>
